...
static inline sint32_t vfs_close( int fd ) {
...
static inline sint32_t vfs_read( int fd, void *ptr, size_t len ) {
  vfs_file *f = (vfs_file *)fd;
...
static inline sint32_t vfs_lseek( int fd, sint32_t off, int whence ) {
  vfs_file *f = (vfs_file *)fd;
...
static inline sint32_t vfs_eof( int fd ) {
  vfs_file *f = (vfs_file *)fd;
...
static inline sint32_t vfs_tell( int fd ) {
  vfs_file *f = (vfs_file *)fd;
...
static inline sint32_t vfs_flush( int fd ) {
  vfs_file *f = (vfs_file *)fd;
...
//   dd: dir descriptor
//   Returns: VFS_RES_OK, or VFS_RES_ERR in case of error
static inline sint32_t vfs_closedir( vfs_dir *dd ) { return dd->fns->close( dd ); }
...
static inline sint32_t vfs_readdir( vfs_dir *dd, struct vfs_stat *buf ) { return dd->fns->readdir( dd, buf ); }
...
//   vol: volume object
//   Returns: VFS_RES_OK, or VFS_RES_ERR in case of error
static inline sint32_t vfs_umount( vfs_vol *vol ) { return vol->fns->umount( vol ); }
